...
// Use process.env directly to avoid server-side env validation in browser
 ...
 * Used to configure edit intent links, for Presentation Mode, as well as to configure where the Studio is mounted in the router.
 */
export const title = process.env.NEXT_PUBLIC_SANITY_PROJECT_TITLE || "Farmer-gq - Personal Site with Sanity.io and Next.js";
