        ...
        <div className="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
          {socialMedia &&
            socialMedia.map((socail, key) => (
              ...
              >
                <i
                  className={`bx bxl-${socail.icon}-square hover:text-yellow text-2xl text-white`}
                ></i>
              </a>
            ))}
          ...
          <a
            href="https://github.com/andyfarmerTUISHG"
            className="bx hover:text-yellow text-2xl text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24px"
