...
import LastFilmWatchedClient from "../components/last-film-watched-client";
...
export default function page() {
  return (
    <>
        ...
        <ProfileStyles>
          <div className="profile">
            ...
            <ul className="social-icons">
              <li>
                <a
                  href="https://www.instagram.com/andyfarmer0676/"
                  title="Instagram"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/andyfarmer0676/"
                  title="Linkedin"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="profile-name">
              ...
              <div className="profile-bio">
                I`m a Website Development Manager,
                {" "}
                <br />
      ...
      {/* Last Film Watched Section */}
      <section className="container mx-auto px-4 py-8">
        <LastFilmWatchedClient />
      </section>
    </>
  );
}
